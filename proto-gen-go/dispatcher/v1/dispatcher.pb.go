...
type UserOnlineDuration struct {
	...
	StatDate int64 `protobuf:"varint,3,opt,name=stat_date,json=statDate,proto3" json:"stat_date,omitempty"` // 统计的日期年月日
}
...
func (x *UserOnlineDuration) GetStatDate() int64 {
	if x != nil {
		return x.StatDate
	}
	return 0
...
var file_dispatcher_v1_dispatcher_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	0x73, 0x74, 0x61, 0x74, 0x44, 0x61, 0x74, 0x65, 0x32, 0xcd, 0x02, 0x0a, 0x0f, 0x44, 0x69, 0x73,
	0x70, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x41, 0x73, 0x79, 0x6e, 0x63, 0x12, 0x70, 0x0a, 0x1c,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x46, 0x6f, 0x72, 0x74, 0x75, 0x6e, 0x65, 0x54, 0x72, 0x65,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x2e, 0x2e, 0x64,
	0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x46, 0x6f, 0x72, 0x74, 0x75, 0x6e, 0x65, 0x54, 0x72, 0x65, 0x65, 0x53, 0x74,
	...
	0x70, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x62,
	0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x72, 0x6f, 0x70, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x27, 0x2e, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74,
	0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x72,
	0x6f, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71,
...
var file_dispatcher_v1_dispatcher_proto_depIdxs = []int32{
	...
	0, // 4: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:input_type -> dispatcher.v1.DispatcherReq
	0, // 5: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:input_type -> dispatcher.v1.DispatcherReq
	0, // 6: dispatcher.v1.DispatcherTimer.CycleCropStageUpdate:input_type -> dispatcher.v1.DispatcherReq
	0, // 7: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:input_type -> dispatcher.v1.DispatcherReq
	0, // 8: dispatcher.v1.DispatcherTimer.CycleOnlineRewardTask:input_type -> dispatcher.v1.DispatcherReq
	1, // 9: dispatcher.v1.DispatcherAsync.UpdateFortuneTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 10: dispatcher.v1.DispatcherAsync.UpdateCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 11: dispatcher.v1.DispatcherAsync.UpdateOnlineRewardTask:output_type -> dispatcher.v1.DispatcherReply
	1, // 12: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 13: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 14: dispatcher.v1.DispatcherTimer.CycleCropStageUpdate:output_type -> dispatcher.v1.DispatcherReply
	1, // 15: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 16: dispatcher.v1.DispatcherTimer.CycleOnlineRewardTask:output_type -> dispatcher.v1.DispatcherReply
