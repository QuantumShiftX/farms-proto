...
var file_dispatcher_v1_dispatcher_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x79, 0x32, 0x5e, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x65,
	0x72, 0x41, 0x73, 0x79, 0x6e, 0x63, 0x12, 0x4b, 0x0a, 0x09, 0x54, 0x65, 0x73, 0x74, 0x41, 0x73,
	0x79, 0x6e, 0x63, 0x12, 0x1c, 0x2e, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72,
	...
	0x79, 0x22, 0x00, 0x32, 0xf9, 0x02, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x72, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x12, 0x5d, 0x0a, 0x1b, 0x43, 0x79, 0x63, 0x6c, 0x65,
	0x46, 0x65, 0x72, 0x74, 0x69, 0x6c, 0x65, 0x54, 0x72, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x72, 0x6f, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x1c,
	...
	0x72, 0x52, 0x65, 0x71, 0x1a, 0x1e, 0x2e, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x57, 0x0a, 0x15, 0x43, 0x79, 0x63, 0x6c, 0x65, 0x42,
	0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0x4d, 0x73, 0x67, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12,
...
var file_dispatcher_v1_dispatcher_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_dispatcher_v1_dispatcher_proto_depIdxs = []int32{
	0, // 0: dispatcher.v1.DispatcherAsync.TestAsync:input_type -> dispatcher.v1.DispatcherReq
	0, // 1: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:input_type -> dispatcher.v1.DispatcherReq
	0, // 2: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:input_type -> dispatcher.v1.DispatcherReq
	0, // 3: dispatcher.v1.DispatcherTimer.CycleCropStageUpdate:input_type -> dispatcher.v1.DispatcherReq
	0, // 4: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:input_type -> dispatcher.v1.DispatcherReq
	1, // 5: dispatcher.v1.DispatcherAsync.TestAsync:output_type -> dispatcher.v1.DispatcherReply
	1, // 6: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 7: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 8: dispatcher.v1.DispatcherTimer.CycleCropStageUpdate:output_type -> dispatcher.v1.DispatcherReply
	1, // 9: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:output_type -> dispatcher.v1.DispatcherReply
