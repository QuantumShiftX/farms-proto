...
var file_dispatcher_v1_dispatcher_proto_depIdxs = []int32{
	...
	1, // 6: dispatcher.v1.DispatcherAsync.UpdateFortuneTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 7: dispatcher.v1.DispatcherAsync.UpdateCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 8: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 9: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 10: dispatcher.v1.DispatcherTimer.CycleCropStageUpdate:output_type -> dispatcher.v1.DispatcherReply
	1, // 11: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:output_type -> dispatcher.v1.DispatcherReply
