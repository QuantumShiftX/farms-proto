...
var file_dispatcher_v1_dispatcher_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x00, 0x32, 0xa1, 0x02, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68,
...
var file_dispatcher_v1_dispatcher_proto_depIdxs = []int32{
	...
	0, // 3: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:input_type -> dispatcher.v1.DispatcherReq
	1, // 4: dispatcher.v1.DispatcherAsync.TestAsync:output_type -> dispatcher.v1.DispatcherReply
	1, // 5: dispatcher.v1.DispatcherTimer.CycleFertileTreeStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 6: dispatcher.v1.DispatcherTimer.CycleCropStatusCheck:output_type -> dispatcher.v1.DispatcherReply
	1, // 7: dispatcher.v1.DispatcherTimer.CycleBulletinMsgCheck:output_type -> dispatcher.v1.DispatcherReply
