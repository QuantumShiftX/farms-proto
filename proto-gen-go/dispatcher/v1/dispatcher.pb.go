...
type UserRechargeEventReq struct {
	...
	IsSuccess int64  `protobuf:"varint,4,opt,name=is_success,json=isSuccess,proto3" json:"is_success,omitempty"` //  1 成功 2 失败
}
...
func (x *UserRechargeEventReq) GetIsSuccess() int64 {
	if x != nil {
		return x.IsSuccess
	}
	return 0
...
func (x *UserWithdrawEventReq) GetIsSuccess() int64 {
	if x != nil {
		return x.IsSuccess
	}
	return 0
...
var file_dispatcher_v1_dispatcher_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x69, 0x6e, 0x22, 0x81, 0x01, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x63,
	...
	0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f,
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x69,
	0x73, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x14, 0x55, 0x73, 0x65,
	...
	0x03, 0x52, 0x09, 0x69, 0x73, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x6b, 0x0a, 0x18,
