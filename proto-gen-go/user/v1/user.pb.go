...
const (
	...
	MessageID_USER_LAND_DETAIL     MessageID = 401
...
type UserEditPersonalInfoMsgReq struct {
	...
	UserId               int64         `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                                                                        // 用户身份验证令牌，必填
	Visualization        int64         `protobuf:"varint,2,opt,name=visualization,proto3" json:"visualization,omitempty"`                                                                        // 用户形象ID，可选（后端提供枚举值）
...
func (x *UserEditPersonalInfoMsgReq) GetVisualization() int64 {
	if x != nil {
...
type FarmsStoreInfoMsgReply struct {
	...
	Rows []*StoreInfo `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"` // 商品信息列表
}
...
type StoreInfo struct {
	...
	ProductType     ProductType   `protobuf:"varint,2,opt,name=product_type,json=productType,proto3,enum=user.v1.ProductType" json:"product_type,omitempty"` // 商品类型
	...
	IsFree          BooleanStatus `protobuf:"varint,8,opt,name=is_free,json=isFree,proto3,enum=user.v1.BooleanStatus" json:"is_free,omitempty"`              // 是否可以免费领取
	IsEnabled       BooleanStatus `protobuf:"varint,9,opt,name=is_enabled,json=isEnabled,proto3,enum=user.v1.BooleanStatus" json:"is_enabled,omitempty"`     // 是否启用
}
...
type UserStorageInfoMsgReply struct {
	...
	Rows []*UserStorageDetail `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"` // 用户仓库物品列表
}
...
type UserLandInfoMsgReply struct {
	...
	Rows []*UserLandDetail `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"` // 用户土地信息列表
}
...
type UserFarmOpsMsgReq struct {
	...
	OpLandPosition int64             `protobuf:"varint,5,opt,name=op_land_position,json=opLandPosition,proto3" json:"op_land_position,omitempty"`                     // 被操作的土地位置编号，必填
}
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0xdb, 0x03, 0x0a, 0x18, 0x55, 0x73, 0x65, 0x72, 0x50, 0x65, 0x72, 0x73, 0x6f,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x76, 0x69, 0x70, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	...
	0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61,
	0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61,
	0x74, 0x61, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x0f, 0x20, 0x01,
	...
	0x2d, 0x0a, 0x07, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x73, 0x18, 0x11, 0x20, 0x03, 0x28, 0x0b,
	...
	0x22, 0xc6, 0x01, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x45, 0x64, 0x69, 0x74, 0x50, 0x65, 0x72,
	0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0d, 0x76, 0x69, 0x73, 0x75,
	0x61, 0x6c, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0d, 0x76, 0x69, 0x73, 0x75, 0x61, 0x6c, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x
x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x61, 0x72, 0x6d, 0x73, 0x53, 0x74, 0x6f, 0x72, 0x65,
	...
	0x79, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x72, 0x6d, 0x4f,
	0x70, 0x73, 0x12, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x46, 0x61, 0x72, 0x6d, 0x4f, 0x70, 0x73, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x1a, 0x11,
...
var file_user_v1_user_proto_goTypes = []interface{}{
	...
	(*FarmsStoreInfoMsgReq)(nil),       // 31: user.v1.FarmsStoreInfoMsgReq
	(*FarmsStoreInfoMsgReply)(nil),     // 32: user.v1.FarmsStoreInfoMsgReply
	(*StoreInfo)(nil),                  // 33: user.v1.StoreInfo
	(*UserStorageInfoMsgReq)(nil),      // 34: user.v1.UserStorageInfoMsgReq
	(*UserStorageInfoMsgReply)(nil),    // 35: user.v1.UserStorageInfoMsgReply
	(*UserStorageDetail)(nil),          // 36: user.v1.UserStorageDetail
	(*UserFarmInfoMsgReq)(nil),         // 37: user.v1.UserFarmInfoMsgReq
	(*UserFarmInfoMsgReply)(nil),       // 38: user.v1.UserFarmInfoMsgReply
	(*UserLandInfoMsgReply)(nil),       // 39: user.v1.UserLandInfoMsgReply
	(*UserLandDetail)(nil),             // 40: user.v1.UserLandDetail
	(*UserPlantingDetail)(nil),         // 41: user.v1.UserPlantingDetail
	(*UserFarmOpsMsgReq)(nil),          // 42: user.v1.UserFarmOpsMsgReq
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	6,  // 4: user.v1.UserWallet.usage_type:type_name -> user.v1.WalletUsageType
	7,  // 5: user.v1.UserWallet.is_default_deposit:type_name -> user.v1.BooleanStatus
	7,  // 6: user.v1.UserWallet.is_default_withdrawal:type_name -> user.v1.BooleanStatus
	5,  // 7: user.v1.UserBalance.wallet_type:type_name -> user.v1.WalletType
	33, // 8: user.v1.FarmsStoreInfoMsgReply.rows:type_name -> user.v1.StoreInfo
	8,  // 9: user.v1.StoreInfo.product_type:type_name -> user.v1.ProductType
	7,  // 10: user.v1.StoreInfo.is_free:type_name -> user.v1.BooleanStatus
	7,  // 11: user.v1.StoreInfo.is_enabled:type_name -> user.v1.BooleanStatus
	36, // 12: user.v1.UserStorageInfoMsgReply.rows:type_name -> user.v1.UserStorageDetail
	8,  // 13: user.v1.UserStorageDetail.product_type:type_name -> user.v1.ProductType
	7,  // 14: user.v1.UserFarmInfoMsgReply.has_received_free_gift:type_name -> user.v1.BooleanStatus
	7,  // 15: user.v1.UserFarmInfoMsgReply.has_completed_tutorial:type_name -> user.v1.BooleanStatus
	40, // 16: user.v1.UserLandInfoMsgReply.rows:type_name -> user.v1.UserLandDetail
	1,  // 17: user.v1.UserLandDetail.status:type_name -> user.v1.LandStatus
	41, // 18: user.v1.UserLandDetail.planted_plant:type_name -> user.v1.UserPlantingDetail
	2,  // 19: user.v1.UserPlantingDetail.is_harvested:type_name -> user.v1.HarvestStatus
	3,  // 20: user.v1.UserPlantingDetail.status:type_name -> user.v1.GrowthStatus
	4,  // 21: user.v1.UserFarmOpsMsgReq.operate_type:type_name -> user.v1.FarmOperationType
	12, // 22: user.v1.UserAuthService.Register:input_type -> user.v1.UserRegisterReq
	13, // 23: user.v1.UserAuthService.Login:input_type -> user.v1.UserSignInReq
	15, // 24: user.v1.UserAuthService.ForgotPwd:input_type -> user.v1.ForgotPasswordReq
	16, // 25: user.v1.UserAuthService.VerifyAccount:input_type -> user.v1.VerifyAccountReq
	17, // 26: user.v1.UserAuthService.LoginOut:input_type -> user.v1.UserSignOutReq
	9,  // 27: user.v1.UserService.Test:input_type -> user.v1.UserReq
	26, // 28: user.v1.UserInnerService.UserConnected:input_type -> user.v1.UserPersonalInfoMsgReq
	26, // 29: user.v1.UserInnerService.UserDisconnected:input_type -> user.v1.UserPersonalInfoMsgReq
	24, // 30: user.v1.UserInnerService.UserAuthentication:input_type -> user.v1.UserAuthInfoMsgReq
	26, // 31: user.v1.UserInnerService.UserPersonalInfo:input_type -> user.v1.UserPersonalInfoMsgReq
	26, // 32: user.v1.UserInnerService.UserEditPersonalInfo:input_type -> user.v1.UserPersonalInfoMsgReq
	31, // 33: user.v1.UserInnerService.FarmsStoreInfo:input_type -> user.v1.FarmsStoreInfoMsgReq
	34, // 34: user.v1.UserInnerService.UserStorageInfo:input_type -> user.v1.UserStorageInfoMsgReq
	37, // 35: user.v1.UserInnerService.UserFarmInfo:input_type -> user.v1.UserFarmInfoMsgReq
	42, // 36: user.v1.UserInnerService.UserFarmOps:input_type -> user.v1.UserFarmOpsMsgReq
	10, // 37: user.v1.UserAuthService.Register:output_type -> user.v1.UserReply
	14, // 38: user.v1.UserAuthService.Login:output_type -> user.v1.UserLoginResp
	10, // 39: user.v1.UserAuthService.ForgotPwd:output_type -> user.v1.UserReply
	10, // 40: user.v1.UserAuthService.VerifyAccount:output_type -> user.v1.UserReply
	10, // 41: user.v1.UserAuthService.LoginOut:output_type -> user.v1.UserReply
	10, // 42: user.v1.UserService.Test:output_type -> user.v1.UserReply
	23, // 43: user.v1.UserInnerService.UserConnected:output_type -> user.v1.MsgReply
	23, // 44: user.v1.UserInnerService.UserDisconnected:output_type -> user.v1.MsgReply
	25, // 45: user.v1.UserInnerService.UserAuthentication:output_type -> user.v1.UserAuthInfoMsgReply
	27, // 46: user.v1.UserInnerService.UserPersonalInfo:output_type -> user.v1.UserPersonalInfoMsgReply
	23, // 47: user.v1.UserInnerService.UserEditPersonalInfo:output_type -> user.v1.MsgReply
	32, // 48: user.v1.UserInnerService.FarmsStoreInfo:output_type -> user.v1.FarmsStoreInfoMsgReply
	35, // 49: user.v1.UserInnerService.UserStorageInfo:output_type -> user.v1.UserStorageInfoMsgReply
	38, // 50: user.v1.UserInnerService.UserFarmInfo:output_type -> user.v1.UserFarmInfoMsgReply
	23, // 51: user.v1.UserInnerService.UserFarmOps:output_type -> user.v1.MsgReply
