...
func (x *UserPurchaseGoodsMsgReq) GetProductId() int64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x64, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x51, 0x0a, 0x17, 0x55, 0x73, 0x65,
	...
	0x03, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x2a, 0xe3, 0x04, 0x0a,
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	12, // 25: user.v1.UserAuthService.Register:input_type -> user.v1.UserRegisterReq
	13, // 26: user.v1.UserAuthService.Login:input_type -> user.v1.UserSignInReq
	15, // 27: user.v1.UserAuthService.ForgotPwd:input_type -> user.v1.ForgotPasswordReq
	16, // 28: user.v1.UserAuthService.VerifyAccount:input_type -> user.v1.VerifyAccountReq
	17, // 29: user.v1.UserAuthService.LoginOut:input_type -> user.v1.UserSignOutReq
	9,  // 30: user.v1.UserService.Test:input_type -> user.v1.UserReq
	26, // 31: user.v1.UserInnerService.UserConnected:input_type -> user.v1.UserPersonalInfoMsgReq
	26, // 32: user.v1.UserInnerService.UserDisconnected:input_type -> user.v1.UserPersonalInfoMsgReq
	24, // 33: user.v1.UserInnerService.UserAuthentication:input_type -> user.v1.UserAuthInfoMsgReq
	26, // 34: user.v1.UserInnerService.UserPersonalInfo:input_type -> user.v1.UserPersonalInfoMsgReq
	28, // 35: user.v1.UserInnerService.UserEditPersonalInfo:input_type -> user.v1.UserEditPersonalInfoMsgReq
	31, // 36: user.v1.UserInnerService.UserStorageInfo:input_type -> user.v1.UserStorageInfoMsgReq
	34, // 37: user.v1.UserInnerService.UserFarmInfo:input_type -> user.v1.UserFarmInfoMsgReq
	36, // 38: user.v1.UserInnerService.UserLandInfo:input_type -> user.v1.UserLandInfoMsgReq
	40, // 39: user.v1.UserInnerService.UserFarmOps:input_type -> user.v1.UserFarmOpsMsgReq
	43, // 40: user.v1.UserInnerService.UserFriendRankingInfo:input_type -> user.v1.UserFriendRankingInfoMsgReq
	41, // 41: user.v1.UserInnerService.AllUserRankingInfo:input_type -> user.v1.AllUserRankingInfoMsgReq
	47, // 42: user.v1.UserInnerService.LookUserFarmsInfo:input_type -> user.v1.LookUserFarmsInfoMsgReq
	49, // 43: user.v1.UserInnerService.UserPurchaseGoods:input_type -> user.v1.UserPurchaseGoodsMsgReq
	10, // 44: user.v1.UserAuthService.Register:output_type -> user.v1.UserReply
	14, // 45: user.v1.UserAuthService.Login:output_type -> user.v1.UserLoginResp
	10, // 46: user.v1.UserAuthService.ForgotPwd:output_type -> user.v1.UserReply
	10, // 47: user.v1.UserAuthService.VerifyAccount:output_type -> user.v1.UserReply
	10, // 48: user.v1.UserAuthService.LoginOut:output_type -> user.v1.UserReply
	10, // 49: user.v1.UserService.Test:output_type -> user.v1.UserReply
	23, // 50: user.v1.UserInnerService.UserConnected:output_type -> user.v1.MsgReply
	23, // 51: user.v1.UserInnerService.UserDisconnected:output_type -> user.v1.MsgReply
	25, // 52: user.v1.UserInnerService.UserAuthentication:output_type -> user.v1.UserAuthInfoMsgReply
	27, // 53: user.v1.UserInnerService.UserPersonalInfo:output_type -> user.v1.UserPersonalInfoMsgReply
	23, // 54: user.v1.UserInnerService.UserEditPersonalInfo:output_type -> user.v1.MsgReply
	32, // 55: user.v1.UserInnerService.UserStorageInfo:output_type -> user.v1.UserStorageInfoMsgReply
	35, // 56: user.v1.UserInnerService.UserFarmInfo:output_type -> user.v1.UserFarmInfoMsgReply
	37, // 57: user.v1.UserInnerService.UserLandInfo:output_type -> user.v1.UserLandInfoMsgReply
	23, // 58: user.v1.UserInnerService.UserFarmOps:output_type -> user.v1.MsgReply
	44, // 59: user.v1.UserInnerService.UserFriendRankingInfo:output_type -> user.v1.UserFriendRankingInfoMsgReply
	42, // 60: user.v1.UserInnerService.AllUserRankingInfo:output_type -> user.v1.AllUserRankingInfoMsgReply
	48, // 61: user.v1.UserInnerService.LookUserFarmsInfo:output_type -> user.v1.LookUserFarmsInfoMsgReply
	23, // 62: user.v1.UserInnerService.UserPurchaseGoods:output_type -> user.v1.MsgReply
