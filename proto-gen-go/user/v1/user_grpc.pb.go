...
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type UserGeneralInnerServiceClient interface {
	// 修改用户余额
...
func NewUserGeneralInnerServiceClient(cc grpc.ClientConnInterface) UserGeneralInnerServiceClient {
	return &userGeneralInnerServiceClient{cc}
}

func (c *userGeneralInnerServiceClient) UpdateUserBalance(ctx context.Context, in *UpdateUserBalanceReq, opts ...grpc.CallOption) (*UpdateUserBalanceResp, error) {
	out := new(UpdateUserBalanceResp)
	err := c.cc.Invoke(ctx, UserGeneralInnerService_UpdateUserBalance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// for forward compatibility
type UserGeneralInnerServiceServer interface {
	// 修改用户余额
...
// UnimplementedUserGeneralInnerServiceServer must be embedded to have forward compatible implementations.
type UnimplementedUserGeneralInnerServiceServer struct {
}
...
// UnsafeUserGeneralInnerServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to UserGeneralInnerServiceServer will
// result in compilation errors.
type UnsafeUserGeneralInnerServiceServer interface {
	mustEmbedUnimplementedUserGeneralInnerServiceServer()
}

func RegisterUserGeneralInnerServiceServer(s grpc.ServiceRegistrar, srv UserGeneralInnerServiceServer) {
	s.RegisterService(&UserGeneralInnerService_ServiceDesc, srv)
}

func _UserGeneralInnerService_UpdateUserBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateUserBalanceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserGeneralInnerServiceServer).UpdateUserBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserGeneralInnerService_UpdateUserBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserGeneralInnerServiceServer).UpdateUserBalance(ctx, req.(*UpdateUserBalanceReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserGeneralInnerService_AddGrowth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddGrowthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserGeneralInnerServiceServer).AddGrowth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserGeneralInnerService_AddGrowth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserGeneralInnerServiceServer).AddGrowth(ctx, req.(*AddGrowthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var UserGeneralInnerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.v1.UserGeneralInnerService",
	HandlerType: (*UserGeneralInnerServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UpdateUserBalance",
			Handler:    _UserGeneralInnerService_UpdateUserBalance_Handler,
		},
		{
