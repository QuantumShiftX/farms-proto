...
type ApplyAgentPayRequest struct {
	...
	ProductId      int64  `protobuf:"varint,2,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`               // 代付产品ID
	...
	Province       string `protobuf:"bytes,10,opt,name=province,proto3" json:"province,omitempty"`                                  // 开户所在地域
	City           string `protobuf:"bytes,11,opt,name=city,proto3" json:"city,omitempty"`                                          // 开户所在地区
	AccountAttr    int64  `protobuf:"varint,12,opt,name=account_attr,json=accountAttr,proto3" json:"account_attr,omitempty"`        // 账户属性(0-对私,1-对公)
	BankNumber     string `protobuf:"bytes,13,opt,name=bank_number,json=bankNumber,proto3" json:"bank_number,omitempty"`            // 联行号或CPF号码
	Uid            string `protobuf:"bytes,14,opt,name=uid,proto3" json:"uid,omitempty"`                                            // 用户唯一标识
	UserName       string `protobuf:"bytes,15,opt,name=user_name,json=userName,proto3" json:"user_name,omitempty"`                  // 用户姓名
	UserMobile     string `protobuf:"bytes,16,opt,name=user_mobile,json=userMobile,proto3" json:"user_mobile,omitempty"`            // 用户电话
	UserEmail      string `protobuf:"bytes,17,opt,name=user_email,json=userEmail,proto3" json:"user_email,omitempty"`               // 用户邮箱
	NotifyUrl      string `protobuf:"bytes,18,opt,name=notify_url,json=notifyUrl,proto3" json:"notify_url,omitempty"`               // 回调URL
	Remark         string `protobuf:"bytes,19,opt,name=remark,proto3" json:"remark,omitempty"`                                      // 备注
	Extra          string `protobuf:"bytes,20,opt,name=extra,proto3" json:"extra,omitempty"`                                        // 扩展域
}
...
func (x *ApplyAgentPayRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *ApplyAgentPayRequest) GetProductId() int64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *ApplyAgentPayRequest) GetAccountAttr() int64 {
	if x != nil {
...
func (x *ApplyAgentPayResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *QueryAgentPayOrderRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *QueryAgentPayBalanceRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *QueryAgentPayBalanceRequest) GetReqTime() string {
	if x != nil {
		return x.ReqTime
	}
	return ""
...
func (x *QueryAgentPayCertificateRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
type CreateOrderRequest struct {
	...
	MchId       int64  `protobuf:"varint,1,opt,name=mch_id,json=mchId,proto3" json:"mch_id,omitempty"`                   // 商户ID
	ProductId   int64  `protobuf:"varint,2,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`       // 支付产品ID
	...
	ReturnUrl   string `protobuf:"bytes,8,opt,name=return_url,json=returnUrl,proto3" json:"return_url,omitempty"`        // 支付结果前端跳转URL
	NotifyUrl   string `protobuf:"bytes,9,opt,name=notify_url,json=notifyUrl,proto3" json:"notify_url,omitempty"`        // 支付结果后台回调URL
	Subject     string `protobuf:"bytes,10,opt,name=subject,proto3" json:"subject,omitempty"`                            // 商品主题
	Body        string `protobuf:"bytes,11,opt,name=body,proto3" json:"body,omitempty"`                                  // 商品描述信息
...
func (x *CreateOrderRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *CreateOrderRequest) GetNotifyUrl() string {
	if x != nil {
		return x.NotifyUrl
	}
	return ""
...
func (x *CreateOrderRequest) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *QueryOrderRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *QueryOrderByUTRRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
type CreateCashierRequest struct {
	...
	Body       string `protobuf:"bytes,8,opt,name=body,proto3" json:"body,omitempty"`                                 // 商品描述信息
...
func (x *CreateCashierRequest) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *CreateCashierRequest) GetProductId() int64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *CreateCashierRequest) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
type PayNotifyData struct {
	...
	MchId          int64  `protobuf:"varint,2,opt,name=mch_id,json=mchId,proto3" json:"mch_id,omitempty"`                             // 商户ID
	ProductId      int64  `protobuf:"varint,3,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`                 // 支付产品ID
...
func (x *PayNotifyData) GetMchId() int64 {
	if x != nil {
		return x.MchId
	}
	return 0
...
func (x *PayNotifyData) GetProductId() int64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
var file_payment_v1_payment_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0xda, 0x04, 0x0a, 0x14, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x41, 0x67,
	0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15, 0x0a,
	0x06, 0x6d, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6d,
	...
	0x74, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x63, 0x68, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x6e, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x63, 0x68, 0x4f, 0x72,
	...
	0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x6f, 0x6c,
	0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x62, 0x61, 0x6e, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x6e, 0x63, 0x65, 0x18, 0x0a, 0x20,
	...
	0x79, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x74, 0x74,
	0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x41, 0x74, 0x74, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x6e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x62, 0x61, 0x6e, 0x6b, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01,
	...
	,
	...
	0x2b, 0x0a, 0x12, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x50, 0x61, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x10, 0x0a, 0x03,
	0x66, 0x65, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x78, 0x74, 0x72, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06,
	...
	0x22, 0x81, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50,
	0x61, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15,
	0x0a, 0x06, 0x6d, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x2b, 0x0a, 0x12, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x5f, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x49, 0x64, 0x22, 0x8f, 0x02, 0x0a, 0x1a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x67,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x20,
	0x0a, 0x0c, 0x6d, 0x63, 0x68, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x63, 0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f,
	0x12, 0x2b, 0x0a, 0x12, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a,
	...
	0x28, 0x03, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x1b, 0x0a, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x5f, 0x6d, 0x73, 0x67, 0x18, 0x07, 0x20, 0x01,
	...
	0x72, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0x63, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0xff, 0x01, 0x0a, 0x1c,
	...
	,
	...
	0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67,
	0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0x87, 0x01,
	0x0a, 0x1f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x43,
	...
	0x03, 0x52, 0x05, 0x6d, 0x63, 0x68, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x63, 0x68, 0x5f,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x6d, 0x63, 0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x2b, 0x0a, 0x12, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x79,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xae, 0x02, 0x0a, 0x20, 0x51, 0x75, 0x65, 0x72,
	...
	0x72, 0x65, 0x74, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x72, 0x65, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x63, 0x68, 0x5f, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d,
	0x63, 0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x2b, 0x0a, 0x12, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x4f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x74, 0x4d, 0x73, 0x67, 0x12, 0x15, 0x0a, 0x06, 0x6d,
	0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6d, 0x63, 0x68,
	...
	0x64, 0x12, 0x20, 0x0a, 0x0c, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61, 0x79, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x63, 0x68, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x6e, 0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x63, 0x68, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	...
	0x73, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x75, 0x73, 0x65,
	0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	0x55, 0x73, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x10, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	...
	,
	...
	,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x5f,
	0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x74, 0x75, 0x72,
	...
	0x55, 0x72, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x07,
	...
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x75, 0x69, 0x64, 0x22, 0x78, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x73,
	0x68, 0x69, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a, 0x08,
	0x72, 0x65, 0x74, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	...
	0x09, 0x52, 0x06, 0x70, 0x61, 0x79, 0x55, 0x72, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67,
	0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0x8f, 0x03,
	0x0a, 0x0d, 0x50, 0x61, 0x79, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x20, 0x0a, 0x0c, 0x70, 0x61, 0x79, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x03, 0x52, 0x05, 0x6d, 0x63, 0x68, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x64,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x65, 0x0a, 0x12, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	0x25, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xe7, 0x02, 0x0a, 0x13, 0x50, 0x61, 0x79, 0x6d,
	...
	,
	...
	0x61, 0x74, 0x65, 0x43, 0x61, 0x73, 0x68, 0x69, 0x65, 0x72, 0x12, 0x20, 0x2e, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x73, 0x68, 0x69, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e, 0x70,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x43, 0x61, 0x73, 0x68, 0x69, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
...
var file_payment_v1_payment_proto_goTypes = []interface{}{
	...
	(*ApplyAgentPayRequest)(nil),             // 2: payment.v1.ApplyAgentPayRequest
	(*ApplyAgentPayResponse)(nil),            // 3: payment.v1.ApplyAgentPayResponse
	(*QueryAgentPayOrderRequest)(nil),        // 4: payment.v1.QueryAgentPayOrderRequest
	(*QueryAgentPayOrderResponse)(nil),       // 5: payment.v1.QueryAgentPayOrderResponse
	(*QueryAgentPayBalanceRequest)(nil),      // 6: payment.v1.QueryAgentPayBalanceRequest
	(*QueryAgentPayBalanceResponse)(nil),     // 7: payment.v1.QueryAgentPayBalanceResponse
	(*QueryAgentPayCertificateRequest)(nil),  // 8: payment.v1.QueryAgentPayCertificateRequest
	(*QueryAgentPayCertificateResponse)(nil), // 9: payment.v1.QueryAgentPayCertificateResponse
	(*AgentPayNotifyRequest)(nil),            // 10: payment.v1.AgentPayNotifyRequest
	(*AgentPayNotifyResponse)(nil),           // 11: payment.v1.AgentPayNotifyResponse
	(*CreateOrderRequest)(nil),               // 12: payment.v1.CreateOrderRequest
	(*CreateOrderResponse)(nil),              // 13: payment.v1.CreateOrderResponse
	(*PayParams)(nil),                        // 14: payment.v1.PayParams
	(*QueryOrderRequest)(nil),                // 15: payment.v1.QueryOrderRequest
	(*QueryOrderResponse)(nil),               // 16: payment.v1.QueryOrderResponse
	(*QueryOrderByUTRRequest)(nil),           // 17: payment.v1.QueryOrderByUTRRequest
	(*CreateCashierRequest)(nil),             // 18: payment.v1.CreateCashierRequest
	(*CreateCashierResponse)(nil),            // 19: payment.v1.CreateCashierResponse
	(*PayNotifyData)(nil),                    // 20: payment.v1.PayNotifyData
	(*PayNotifyResponse)(nil),                // 21: payment.v1.PayNotifyResponse
	nil,                                      // 22: payment.v1.PayParams.AdditionalParamsEntry
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	14, // 0: payment.v1.CreateOrderResponse.pay_params:type_name -> payment.v1.PayParams
	22, // 1: payment.v1.PayParams.additional_params:type_name -> payment.v1.PayParams.AdditionalParamsEntry
	2,  // 2: payment.v1.AgentPayInnerService.ApplyAgentPay:input_type -> payment.v1.ApplyAgentPayRequest
	4,  // 3: payment.v1.AgentPayInnerService.QueryAgentPayOrder:input_type -> payment.v1.QueryAgentPayOrderRequest
	10, // 4: payment.v1.AgentPayInnerService.HandleAgentPayNotify:input_type -> payment.v1.AgentPayNotifyRequest
	6,  // 5: payment.v1.AgentPayInnerService.QueryAgentPayBalance:input_type -> payment.v1.QueryAgentPayBalanceRequest
	8,  // 6: payment.v1.AgentPayInnerService.QueryAgentPayCertificate:input_type -> payment.v1.QueryAgentPayCertificateRequest
	12, // 7: payment.v1.PaymentInnerService.CreateOrder:input_type -> payment.v1.CreateOrderRequest
	15, // 8: payment.v1.PaymentInnerService.QueryOrder:input_type -> payment.v1.QueryOrderRequest
	17, // 9: payment.v1.PaymentInnerService.QueryOrderByUTR:input_type -> payment.v1.QueryOrderByUTRRequest
	18, // 10: payment.v1.PaymentInnerService.CreateCashier:input_type -> payment.v1.CreateCashierRequest
	3,  // 11: payment.v1.AgentPayInnerService.ApplyAgentPay:output_type -> payment.v1.ApplyAgentPayResponse
	5,  // 12: payment.v1.AgentPayInnerService.QueryAgentPayOrder:output_type -> payment.v1.QueryAgentPayOrderResponse
	11, // 13: payment.v1.AgentPayInnerService.HandleAgentPayNotify:output_type -> payment.v1.AgentPayNotifyResponse
	7,  // 14: payment.v1.AgentPayInnerService.QueryAgentPayBalance:output_type -> payment.v1.QueryAgentPayBalanceResponse
	9,  // 15: payment.v1.AgentPayInnerService.QueryAgentPayCertificate:output_type -> payment.v1.QueryAgentPayCertificateResponse
	13, // 16: payment.v1.PaymentInnerService.CreateOrder:output_type -> payment.v1.CreateOrderResponse
	16, // 17: payment.v1.PaymentInnerService.QueryOrder:output_type -> payment.v1.QueryOrderResponse
	16, // 18: payment.v1.PaymentInnerService.QueryOrderByUTR:output_type -> payment.v1.QueryOrderResponse
	19, // 19: payment.v1.PaymentInnerService.CreateCashier:output_type -> payment.v1.CreateCashierResponse
