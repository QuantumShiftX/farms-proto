...
var file_payment_v1_payment_proto_rawDesc = []byte{
	...
	0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x32, 0x9c, 0x04, 0x0a, 0x14, 0x41, 0x67, 0x65, 0x6e,
	...
	0x32, 0x91, 0x08, 0x0a, 0x17, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
...
var file_payment_v1_payment_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_payment_v1_payment_proto_goTypes = []interface{}{
	...
	nil,                                      // 50: payment.v1.PayParams.AdditionalParamsEntry
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	50, // 0: payment.v1.PayParams.additional_params:type_name -> payment.v1.PayParams.AdditionalParamsEntry
	...
	3,  // 11: payment.v1.AgentPayInnerService.ApplyAgentPay:input_type -> payment.v1.ApplyAgentPayRequest
	5,  // 12: payment.v1.AgentPayInnerService.QueryAgentPayOrder:input_type -> payment.v1.QueryAgentPayOrderRequest
	9,  // 13: payment.v1.AgentPayInnerService.QueryAgentPayCertificate:input_type -> payment.v1.QueryAgentPayCertificateRequest
	7,  // 14: payment.v1.AgentPayInnerService.QueryAgentPayBalance:input_type -> payment.v1.QueryAgentPayBalanceRequest
	11, // 15: payment.v1.AgentPayInnerService.HandleAgentPayNotify:input_type -> payment.v1.AgentPayNotifyRequest
	13, // 16: payment.v1.PaymentInnerService.CreateOrder:input_type -> payment.v1.CreateOrderRequest
	16, // 17: payment.v1.PaymentInnerService.QueryOrder:input_type -> payment.v1.QueryOrderRequest
	18, // 18: payment.v1.PaymentInnerService.QueryOrderByUTR:input_type -> payment.v1.QueryOrderByUTRRequest
	19, // 19: payment.v1.PaymentInnerService.CreateCashier:input_type -> payment.v1.CreateCashierRequest
	23, // 20: payment.v1.UserPaymentInnerService.UserRecharge:input_type -> payment.v1.UserRechargeInfoMsgReq
	26, // 21: payment.v1.UserPaymentInnerService.UserRechargeConfirm:input_type -> payment.v1.UserRechargeConfirmMsgReq
	28, // 22: payment.v1.UserPaymentInnerService.UserWithdraw:input_type -> payment.v1.UserWithdrawInfoMsgReq
	31, // 23: payment.v1.UserPaymentInnerService.ReceivePaymentNotice:input_type -> payment.v1.PaymentNotificationReq
	32, // 24: payment.v1.UserPaymentInnerService.UserRechargeChannel:input_type -> payment.v1.RechargeChannelsInfoMsgReq
	36, // 25: payment.v1.UserPaymentInnerService.UserSetWithdrawChannel:input_type -> payment.v1.UserSetWithdrawChannelMsgReq
	38, // 26: payment.v1.UserPaymentInnerService.UserWithdrawAccount:input_type -> payment.v1.UserWithdrawAccountInfoMsgReq
	41, // 27: payment.v1.UserPaymentInnerService.UserTransactionRecords:input_type -> payment.v1.UserTransactionRecordsMsgReq
	44, // 28: payment.v1.UserPaymentInnerService.GetBankList:input_type -> payment.v1.GetBankListInfoMsgReq
	47, // 29: payment.v1.UserPaymentInnerService.GetPaymentConfList:input_type -> payment.v1.GetPaymentConfListMsgReq
	4,  // 30: payment.v1.AgentPayInnerService.ApplyAgentPay:output_type -> payment.v1.ApplyAgentPayResponse
	6,  // 31: payment.v1.AgentPayInnerService.QueryAgentPayOrder:output_type -> payment.v1.QueryAgentPayOrderResponse
	10, // 32: payment.v1.AgentPayInnerService.QueryAgentPayCertificate:output_type -> payment.v1.QueryAgentPayCertificateResponse
	8,  // 33: payment.v1.AgentPayInnerService.QueryAgentPayBalance:output_type -> payment.v1.QueryAgentPayBalanceResponse
	12, // 34: payment.v1.AgentPayInnerService.HandleAgentPayNotify:output_type -> payment.v1.AgentPayNotifyResponse
	14, // 35: payment.v1.PaymentInnerService.CreateOrder:output_type -> payment.v1.CreateOrderResponse
	17, // 36: payment.v1.PaymentInnerService.QueryOrder:output_type -> payment.v1.QueryOrderResponse
	17, // 37: payment.v1.PaymentInnerService.QueryOrderByUTR:output_type -> payment.v1.QueryOrderResponse
	20, // 38: payment.v1.PaymentInnerService.CreateCashier:output_type -> payment.v1.CreateCashierResponse
	24, // 39: payment.v1.UserPaymentInnerService.UserRecharge:output_type -> payment.v1.UserRechargeInfoMsgReply
	27, // 40: payment.v1.UserPaymentInnerService.UserRechargeConfirm:output_type -> payment.v1.UserRechargeConfirmMsgReply
	29, // 41: payment.v1.UserPaymentInnerService.UserWithdraw:output_type -> payment.v1.UserWithdrawInfoMsgReply
	1,  // 42: payment.v1.UserPaymentInnerService.ReceivePaymentNotice:output_type -> payment.v1.PaymentReply
	33, // 43: payment.v1.UserPaymentInnerService.UserRechargeChannel:output_type -> payment.v1.RechargeChannelsInfoMsgReply
	37, // 44: payment.v1.UserPaymentInnerService.UserSetWithdrawChannel:output_type -> payment.v1.UserSetWithdrawChannelMsgReply
	39, // 45: payment.v1.UserPaymentInnerService.UserWithdrawAccount:output_type -> payment.v1.UserWithdrawAccountInfoMsgReply
	42, // 46: payment.v1.UserPaymentInnerService.UserTransactionRecords:output_type -> payment.v1.UserTransactionRecordsMsgReply
	45, // 47: payment.v1.UserPaymentInnerService.GetBankList:output_type -> payment.v1.GetBankListInfoMsgReply
	48, // 48: payment.v1.UserPaymentInnerService.GetPaymentConfList:output_type -> payment.v1.GetPaymentConfListMsgReply
