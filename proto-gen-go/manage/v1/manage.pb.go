...
var file_manage_v1_manage_proto_rawDesc = string([]byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x32, 0x47, 0x0a, 0x0d, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x54, 0x65, 0x73, 0x74, 0x12, 0x14, 0x2e,
	...
	,
...
var file_manage_v1_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_manage_v1_manage_proto_goTypes = []any{
	(*ManageReq)(nil),            // 0: manage.v1.ManageReq
	(*ManageReply)(nil),          // 1: manage.v1.ManageReply
	(*VipLevelDetail)(nil),       // 2: manage.v1.VipLevelDetail
	(*DefaultVipInfoReply)(nil),  // 3: manage.v1.DefaultVipInfoReply
	(*SettingBaseInfoReply)(nil), // 4: manage.v1.SettingBaseInfoReply
	(*RegistrationRewards)(nil),  // 5: manage.v1.RegistrationRewards
	(*DepositRewards)(nil),       // 6: manage.v1.DepositRewards
	(*CollectionRewards)(nil),    // 7: manage.v1.CollectionRewards
	(*SettlementConfig)(nil),     // 8: manage.v1.SettlementConfig
}
var file_manage_v1_manage_proto_depIdxs = []int32{
	2, // 0: manage.v1.DefaultVipInfoReply.vip_info:type_name -> manage.v1.VipLevelDetail
	5, // 1: manage.v1.SettingBaseInfoReply.registration_rewards:type_name -> manage.v1.RegistrationRewards
	6, // 2: manage.v1.SettingBaseInfoReply.deposit_rewards:type_name -> manage.v1.DepositRewards
	7, // 3: manage.v1.SettingBaseInfoReply.collection_rewards:type_name -> manage.v1.CollectionRewards
	8, // 4: manage.v1.SettingBaseInfoReply.settlement_config:type_name -> manage.v1.SettlementConfig
	0, // 5: manage.v1.ManageService.Test:input_type -> manage.v1.ManageReq
	...
	1, // 8: manage.v1.ManageService.Test:output_type -> manage.v1.ManageReply
	3, // 9: manage.v1.ManageInnerService.GetDefaultVipInfo:output_type -> manage.v1.DefaultVipInfoReply
	4, // 10: manage.v1.ManageInnerService.GetSettingBaseInfo:output_type -> manage.v1.SettingBaseInfoReply
