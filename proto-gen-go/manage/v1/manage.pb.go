...
type GetSystemConfReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	IsRegisterVerify int64  `protobuf:"varint,3,opt,name=is_register_verify,json=isRegisterVerify,proto3" json:"is_register_verify,omitempty"` // 是否开启注册验证 1 开启 2 关闭
}

func (x *GetSystemConfReply) Reset() {
	*x = GetSystemConfReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetSystemConfReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSystemConfReply) ProtoMessage() {}

func (x *GetSystemConfReply) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSystemConfReply.ProtoReflect.Descriptor instead.
func (*GetSystemConfReply) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{3}
}

func (x *GetSystemConfReply) GetUserAgreement() string {
	if x != nil {
...
func (x *GetSystemConfReply) GetPrivacyNotice() string {
	if x != nil {
...
func (x *GetSystemConfReply) GetIsRegisterVerify() int64 {
	if x != nil {
...
type ExchangeRateSettingInfoReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CurrentBaseRate     int64 `protobuf:"varint,1,opt,name=current_base_rate,json=currentBaseRate,proto3" json:"current_base_rate,omitempty"`           // 当前基准汇率（实际生效的值）
	ScheduledBaseRate   int64 `protobuf:"varint,2,opt,name=scheduled_base_rate,json=scheduledBaseRate,proto3" json:"scheduled_base_rate,omitempty"`     // 预设基准汇率（将于当天0点生效）
	UpwardFluctuation   int64 `protobuf:"varint,3,opt,name=upward_fluctuation,json=upwardFluctuation,proto3" json:"upward_fluctuation,omitempty"`       // 上浮幅度（正向波动范围）
	DownwardFluctuation int64 `protobuf:"varint,4,opt,name=downward_fluctuation,json=downwardFluctuation,proto3" json:"downward_fluctuation,omitempty"` // 下浮幅度（负向波动范围）
}

func (x *ExchangeRateSettingInfoReply) Reset() {
	*x = ExchangeRateSettingInfoReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExchangeRateSettingInfoReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExchangeRateSettingInfoReply) ProtoMessage() {}

func (x *ExchangeRateSettingInfoReply) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExchangeRateSettingInfoReply.ProtoReflect.Descriptor instead.
func (*ExchangeRateSettingInfoReply) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{13}
}

func (x *ExchangeRateSettingInfoReply) GetCurrentBaseRate() int64 {
	if x != nil {
		return x.CurrentBaseRate
	}
	return 0
}

func (x *ExchangeRateSettingInfoReply) GetScheduledBaseRate() int64 {
	if x != nil {
		return x.ScheduledBaseRate
	}
	return 0
}

func (x *ExchangeRateSettingInfoReply) GetUpwardFluctuation() int64 {
	if x != nil {
		return x.UpwardFluctuation
	}
	return 0
}

func (x *ExchangeRateSettingInfoReply) GetDownwardFluctuation() int64 {
	if x != nil {
		return x.DownwardFluctuation
	}
	return 0
}
...
func (x *AgentRuleInfoMsgReply) Reset() {
	*x = AgentRuleInfoMsgReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_manage_v1_manage_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AgentRuleInfoMsgReply) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{36}
}
...
func (x *GetRateInfoMsgReq) Reset() {
	*x = GetRateInfoMsgReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_manage_v1_manage_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetRateInfoMsgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRateInfoMsgReq) ProtoMessage() {}

func (x *GetRateInfoMsgReq) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRateInfoMsgReq.ProtoReflect.Descriptor instead.
func (*GetRateInfoMsgReq) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{37}
}

func (x *GetRateInfoMsgReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
// 获取汇率响应
type GetRateInfoMsgReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Rate      int64 `protobuf:"varint,1,opt,name=rate,proto3" json:"rate,omitempty"`           // 汇率
	Timestamp int64 `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // 时间戳
}

func (x *GetRateInfoMsgReply) Reset() {
	*x = GetRateInfoMsgReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_manage_v1_manage_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetRateInfoMsgReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRateInfoMsgReply) ProtoMessage() {}

func (x *GetRateInfoMsgReply) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRateInfoMsgReply.ProtoReflect.Descriptor instead.
func (*GetRateInfoMsgReply) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{38}
}

func (x *GetRateInfoMsgReply) GetRate() int64 {
	if x != nil {
		return x.Rate
	}
	return 0
...
func (x *GetRateInfoMsgReply) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_manage_v1_manage_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x90, 0x01, 0x0a,
	0x12, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x52, 0x65,
	...
	0x65, 0x12, 0x2c, 0x0a, 0x12, 0x69, 0x73, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	0x5f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x69,
	0x73, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x22,
	...
	,
	...
	0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x18, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x69, 0x63, 0x65, 0x22, 0x14, 0x0a, 0x12, 0x56, 0x69, 0x70, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x22, 0x43, 0x0a, 0x14, 0x56, 0x69,
	...
	0x32, 0x17, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x49, 0x50,
	...
	0x09, 0x69, 0x73, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x66, 0x0a, 0x1b, 0x55, 0x73,
	...
	0x49, 0x64, 0x22, 0xb7, 0x01, 0x0a, 0x1d, 0x55, 0x73, 0x65, 0x72, 0x41, 0x6e, 0x6e, 0x6f, 0x75,
	...
	0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x61, 0x67, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x72, 0x6f,
	0x77, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x22, 0x46, 0x0a, 0x17, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x49, 0x6e, 0x66, 0x6f,
	0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x2b, 0x0a, 0x04, 0x72,
	0x6f, 0x77, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x49, 0x6e,
	...
	0x9a, 0x01, 0x0a, 0x15, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x49, 0x6e, 0x66,
	0x6f, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x3e, 0x0a, 0x0d, 0x64, 0x65, 0x70,
	...
	,
	...
	0x61, 0x6d, 0x70, 0x32, 0xc4, 0x02, 0x0a, 0x10, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x41, 0x70,
	0x69, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x42, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64,
	0x43, 0x61, 0x70, 0x74, 0x63, 0x68, 0x61, 0x12, 0x19, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x43, 0x61, 0x70, 0x74, 0x63, 0x68, 0x61, 0x52,
	0x65, 0x71, 0x1a, 0x16, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0d,
	0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x14, 0x2e,
	...
	,
	...
	0x2e, 0x47, 0x65, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x32, 0x8f, 0x09, 0x0a, 0x12, 0x4d,
	...
	,
	...
	,
...
var file_manage_v1_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_manage_v1_manage_proto_goTypes = []interface{}{
	...
	(*GetSystemConfReply)(nil),            // 3: manage.v1.GetSystemConfReply
	...
	(*ExchangeRateSettingInfoReply)(nil),  // 13: manage.v1.ExchangeRateSettingInfoReply
	(*RegistrationRewards)(nil),           // 14: manage.v1.RegistrationRewards
	(*DepositRewards)(nil),                // 15: manage.v1.DepositRewards
	(*CollectionRewards)(nil),             // 16: manage.v1.CollectionRewards
	(*SettlementConfig)(nil),              // 17: manage.v1.SettlementConfig
	(*GetNotificationsListReq)(nil),       // 18: manage.v1.GetNotificationsListReq
	(*GetNotificationsListReply)(nil),     // 19: manage.v1.GetNotificationsListReply
	(*NotificationInfo)(nil),              // 20: manage.v1.NotificationInfo
	(*GetDownloadAddrReply)(nil),          // 21: manage.v1.GetDownloadAddrReply
	(*GetDesignatedVipInfoReq)(nil),       // 22: manage.v1.GetDesignatedVipInfoReq
	(*DesignatedVipInfoReply)(nil),        // 23: manage.v1.DesignatedVipInfoReply
	(*FarmAgreementInfoMsgReq)(nil),       // 24: manage.v1.FarmAgreementInfoMsgReq
	(*FarmAgreementInfoMsgReply)(nil),     // 25: manage.v1.FarmAgreementInfoMsgReply
	(*VipLevelInfoMsgReq)(nil),            // 26: manage.v1.VipLevelInfoMsgReq
	(*VipLevelInfoMsgReply)(nil),          // 27: manage.v1.VipLevelInfoMsgReply
	(*VIPLevelInfo)(nil),                  // 28: manage.v1.VIPLevelInfo
	(*UserAnnouncementsInfoMsgReq)(nil),   // 29: manage.v1.UserAnnouncementsInfoMsgReq
	(*UserAnnouncementsInfoMsgReply)(nil), // 30: manage.v1.UserAnnouncementsInfoMsgReply
	(*AnnouncementsInfo)(nil),             // 31: manage.v1.AnnouncementsInfo
	(*CurrencyInfoMsgReq)(nil),            // 32: manage.v1.CurrencyInfoMsgReq
	(*CurrencyInfoMsgReqReply)(nil),       // 33: manage.v1.CurrencyInfoMsgReqReply
	(*CurrencyInfo)(nil),                  // 34: manage.v1.CurrencyInfo
	(*AgentRuleInfoMsgReq)(nil),           // 35: manage.v1.AgentRuleInfoMsgReq
	(*AgentRuleInfoMsgReply)(nil),         // 36: manage.v1.AgentRuleInfoMsgReply
	(*GetRateInfoMsgReq)(nil),             // 37: manage.v1.GetRateInfoMsgReq
	(*GetRateInfoMsgReply)(nil),           // 38: manage.v1.GetRateInfoMsgReply
	nil,                                   // 39: manage.v1.GetNotificationsListReply.NotificationsEntry
}
var file_manage_v1_manage_proto_depIdxs = []int32{
	...
	14, // 4: manage.v1.SettingBaseInfoReply.registration_rewards:type_name -> manage.v1.RegistrationRewards
	15, // 5: manage.v1.SettingBaseInfoReply.deposit_rewards:type_name -> manage.v1.DepositRewards
	16, // 6: manage.v1.SettingBaseInfoReply.collection_rewards:type_name -> manage.v1.CollectionRewards
	17, // 7: manage.v1.SettingBaseInfoReply.settlement_config:type_name -> manage.v1.SettlementConfig
	39, // 8: manage.v1.GetNotificationsListReply.notifications:type_name -> manage.v1.GetNotificationsListReply.NotificationsEntry
	10, // 9: manage.v1.DesignatedVipInfoReply.vip_info:type_name -> manage.v1.VipLevelDetail
	28, // 10: manage.v1.VipLevelInfoMsgReply.rows:type_name -> manage.v1.VIPLevelInfo
	31, // 11: manage.v1.UserAnnouncementsInfoMsgReply.rows:type_name -> manage.v1.AnnouncementsInfo
	34, // 12: manage.v1.CurrencyInfoMsgReqReply.rows:type_name -> manage.v1.CurrencyInfo
	15, // 13: manage.v1.AgentRuleInfoMsgReply.deposit_rules:type_name -> manage.v1.DepositRewards
	16, // 14: manage.v1.AgentRuleInfoMsgReply.harvest_rules:type_name -> manage.v1.CollectionRewards
	20, // 15: manage.v1.GetNotificationsListReply.NotificationsEntry.value:type_name -> manage.v1.NotificationInfo
	2,  // 16: manage.v1.ManageApiService.SendCaptcha:input_type -> manage.v1.SendCaptchaReq
	0,  // 17: manage.v1.ManageApiService.GetSystemConf:input_type -> manage.v1.ManageReq
	...
	22, // 21: manage.v1.ManageInnerService.GetDesignatedVipInfo:input_type -> manage.v1.GetDesignatedVipInfoReq
	0,  // 22: manage.v1.ManageInnerService.GetSettingBaseInfo:input_type -> manage.v1.ManageReq
	0,  // 23: manage.v1.ManageInnerService.GetExchangeRateSettingInfo:input_type -> manage.v1.ManageReq
	0,  // 24: manage.v1.ManageInnerService.SetExchangeRateSettingInfo:input_type -> manage.v1.ManageReq
	26, // 25: manage.v1.ManageInnerService.VipLevelInfo:input_type -> manage.v1.VipLevelInfoMsgReq
	18, // 26: manage.v1.ManageInnerService.GetNotificationsList:input_type -> manage.v1.GetNotificationsListReq
	0,  // 27: manage.v1.ManageInnerService.GetDownloadAddress:input_type -> manage.v1.ManageReq
	29, // 28: manage.v1.ManageInnerService.UserAnnouncements:input_type -> manage.v1.UserAnnouncementsInfoMsgReq
	24, // 29: manage.v1.ManageInnerService.GetFarmAgreement:input_type -> manage.v1.FarmAgreementInfoMsgReq
	32, // 30: manage.v1.ManageInnerService.GetCurrencyInfoMsg:input_type -> manage.v1.CurrencyInfoMsgReq
	35, // 31: manage.v1.ManageInnerService.GetAgentRuleInfoMsg:input_type -> manage.v1.AgentRuleInfoMsgReq
	37, // 32: manage.v1.ManageInnerService.GetCurrentRateInfoMsg:input_type -> manage.v1.GetRateInfoMsgReq
	1,  // 33: manage.v1.ManageApiService.SendCaptcha:output_type -> manage.v1.ManageReply
	3,  // 34: manage.v1.ManageApiService.GetSystemConf:output_type -> manage.v1.GetSystemConfReply
	4,  // 35: manage.v1.ManageApiService.GetApkAddress:output_type -> manage.v1.GetApkAddressReply
	6,  // 36: manage.v1.ManageApiService.GetCustomerService:output_type -> manage.v1.GetCustomerServiceReply
	11, // 37: manage.v1.ManageInnerService.GetDefaultVipInfo:output_type -> manage.v1.DefaultVipInfoReply
	23, // 38: manage.v1.ManageInnerService.GetDesignatedVipInfo:output_type -> manage.v1.DesignatedVipInfoReply
	12, // 39: manage.v1.ManageInnerService.GetSettingBaseInfo:output_type -> manage.v1.SettingBaseInfoReply
	13, // 40: manage.v1.ManageInnerService.GetExchangeRateSettingInfo:output_type -> manage.v1.ExchangeRateSettingInfoReply
	1,  // 41: manage.v1.ManageInnerService.SetExchangeRateSettingInfo:output_type -> manage.v1.ManageReply
	27, // 42: manage.v1.ManageInnerService.VipLevelInfo:output_type -> manage.v1.VipLevelInfoMsgReply
	19, // 43: manage.v1.ManageInnerService.GetNotificationsList:output_type -> manage.v1.GetNotificationsListReply
	21, // 44: manage.v1.ManageInnerService.GetDownloadAddress:output_type -> manage.v1.GetDownloadAddrReply
	30, // 45: manage.v1.ManageInnerService.UserAnnouncements:output_type -> manage.v1.UserAnnouncementsInfoMsgReply
	25, // 46: manage.v1.ManageInnerService.GetFarmAgreement:output_type -> manage.v1.FarmAgreementInfoMsgReply
	33, // 47: manage.v1.ManageInnerService.GetCurrencyInfoMsg:output_type -> manage.v1.CurrencyInfoMsgReqReply
	36, // 48: manage.v1.ManageInnerService.GetAgentRuleInfoMsg:output_type -> manage.v1.AgentRuleInfoMsgReply
	38, // 49: manage.v1.ManageInnerService.GetCurrentRateInfoMsg:output_type -> manage.v1.GetRateInfoMsgReply
...
func file_manage_v1_manage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_manage_v1_manage_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSystemConfReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_manage_v1_manage_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExchangeRateSettingInfoReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_manage_v1_manage_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_manage_v1_manage_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRateInfoMsgReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_manage_v1_manage_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRateInfoMsgReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
