...
type RechargeInfo struct {
	...
	TransferVoucher      string `protobuf:"bytes,9,opt,name=transfer_voucher,json=transferVoucher,proto3" json:"transfer_voucher,omitempty"`                    // 转账凭证
	ActualReceivedAmount int64  `protobuf:"varint,10,opt,name=actual_received_amount,json=actualReceivedAmount,proto3" json:"actual_received_amount,omitempty"` // 实际接收的金额
	PaymentMethod        int64  `protobuf:"varint,11,opt,name=payment_method,json=paymentMethod,proto3" json:"payment_method,omitempty"`                        // 支付类型 1:USDT虚拟货币 2:银行卡 3: 快捷支付
}
...
func (x *RechargeInfo) GetTransferVoucher() string {
	if x != nil {
...
func (x *RechargeInfo) GetActualReceivedAmount() int64 {
	if x != nil {
...
func (x *RechargeInfo) GetPaymentMethod() int64 {
	if x != nil {
...
type UserRechargeConfirmMsgReq struct {
	...
	OperationType   int64  `protobuf:"varint,6,opt,name=operation_type,json=operationType,proto3" json:"operation_type,omitempty"`      // 操作类型 1：充值确认，2：修改数据
}
...
func (x *UserRechargeConfirmMsgReq) GetOperationType() int64 {
	if x != nil {
...
type UserWithdrawInfoMsgReq struct {
	...
	CurrencyCode    string `protobuf:"bytes,4,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`             // 币种
	PaymentConfigId int64  `protobuf:"varint,5,opt,name=payment_config_id,json=paymentConfigId,proto3" json:"payment_config_id,omitempty"` // 提现方式id
...
func (x *UserWithdrawInfoMsgReq) GetPaymentConfigId() int64 {
	if x != nil {
		return x.PaymentConfigId
	}
	return 0
...
type WithdrawInfo struct {
	...
	OrderStatus          int64  `protobuf:"varint,9,opt,name=order_status,json=orderStatus,proto3" json:"order_status,omitempty"`                               // 订单状态 1 - 待出款 2-待风控审核  3 - 待三方付款  4 - 付款失败 5 - 已拒绝 6 - 已取消  7 - 已付款  8 - 已强制付款；英文版1 - Pending Disbursement 2 - Pending Risk Review 3 - Pending Third-party Payment 4 - Payment Failed 5 - Payment Rejected 6 - Cancelled 7 - Paid 8 - Force Paid
	ActualReceivedAmount int64  `protobuf:"varint,10,opt,name=actual_received_amount,json=actualReceivedAmount,proto3" json:"actual_received_amount,omitempty"` // 实际接收的金额
	PaymentMethod        int64  `protobuf:"varint,11,opt,name=payment_method,json=paymentMethod,proto3" json:"payment_method,omitempty"`                        // 支付类型 1:USDT虚拟货币 2:银行卡 3: 快捷支付
}
...
func (x *WithdrawInfo) GetActualReceivedAmount() int64 {
	if x != nil {
		return x.ActualReceivedAmount
	}
	return 0
...
func (x *WithdrawInfo) GetPaymentMethod() int64 {
	if x != nil {
		return x.PaymentMethod
	}
	return 0
...
type PaymentConfInfo struct {
	...
	MinLimitAmount    int64              `protobuf:"varint,7,opt,name=min_limit_amount,json=minLimitAmount,proto3" json:"min_limit_amount,omitempty"`          // 单笔最小限额，下限
	MaxLimitAmount    int64              `protobuf:"varint,8,opt,name=max_limit_amount,json=maxLimitAmount,proto3" json:"max_limit_amount,omitempty"`          // 单笔最大限额，上限
	FixedFee          int64              `protobuf:"varint,9,opt,name=fixed_fee,json=fixedFee,proto3" json:"fixed_fee,omitempty"`                              // 固定手续费
	PercentageFee     int64              `protobuf:"varint,10,opt,name=percentage_fee,json=percentageFee,proto3" json:"percentage_fee,omitempty"`              // 百分比手续费 以1000000为单位，例如 20%=0.20=0.20×1,000,000=200,000
	RechargeChannel   []*RechargeChannel `protobuf:"bytes,11,rep,name=recharge_channel,json=rechargeChannel,proto3" json:"recharge_channel,omitempty"`         // 充值通道列表
	WithdrawChannel   []*WithdrawChannel `protobuf:"bytes,12,rep,name=withdraw_channel,json=withdrawChannel,proto3" json:"withdraw_channel,omitempty"`         // 提现通道列表
}
...
func (x *PaymentConfInfo) GetMinLimitAmount() int64 {
	if x != nil {
		return x.MinLimitAmount
	}
	return 0
...
func (x *PaymentConfInfo) GetMaxLimitAmount() int64 {
	if x != nil {
		return x.MaxLimitAmount
	}
	return 0
...
func (x *GetPendingOrderMsgReq) GetOrderStatus() int64 {
	if x != nil {
		return x.OrderStatus
	}
	return 0
...
type OrderInfo struct {
	...
	PaymentAmount        int64  `protobuf:"varint,4,opt,name=payment_amount,json=paymentAmount,proto3" json:"payment_amount,omitempty"`                        // 用户提交金额
	ReceivedAmount       int64  `protobuf:"varint,5,opt,name=received_amount,json=receivedAmount,proto3" json:"received_amount,omitempty"`                     // 换汇之后的金额
	ActualReceivedAmount int64  `protobuf:"varint,6,opt,name=actual_received_amount,json=actualReceivedAmount,proto3" json:"actual_received_amount,omitempty"` // 实际接收的金额
	FeeAmount            int64  `protobuf:"varint,7,opt,name=fee_amount,json=feeAmount,proto3" json:"fee_amount,omitempty"`                                    // 手续费
	OrderTime            int64  `protobuf:"varint,8,opt,name=order_time,json=orderTime,proto3" json:"order_time,omitempty"`                                    // 订单时间
	SuccessTime          int64  `protobuf:"varint,9,opt,name=success_time,json=successTime,proto3" json:"success_time,omitempty"`                              // 成功时间
	PaymentMethod        int64  `protobuf:"varint,10,opt,name=payment_method,json=paymentMethod,proto3" json:"payment_method,omitempty"`                       // 支付方式  1:USDT虚拟货币 2:银行卡 3: 快捷支付
	OrderStatus          int64  `protobuf:"varint,11,opt,name=order_status,json=orderStatus,proto3" json:"order_status,omitempty"`                             // 订单状态
	CardName             string `protobuf:"bytes,12,opt,name=card_name,json=cardName,proto3" json:"card_name,omitempty"`                                       // 银行卡名称
	AccountName          string `protobuf:"bytes,13,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"`                              // 账户名称
	CardNumber           string `protobuf:"bytes,14,opt,name=card_number,json=cardNumber,proto3" json:"card_number,omitempty"`                                 // 银行卡号
	TransferVoucher      string `protobuf:"bytes,15,opt,name=transfer_voucher,json=transferVoucher,proto3" json:"transfer_voucher,omitempty"`                  // 转账凭证
	PaymentConfigType    int64  `protobuf:"varint,16,opt,name=payment_config_type,json=paymentConfigType,proto3" json:"payment_config_type,omitempty"`         // 支付配置类型 1: 充值 2: 提现
	PaymentConfigId      int64  `protobuf:"varint,17,opt,name=payment_config_id,json=paymentConfigId,proto3" json:"payment_config_id,omitempty"`               // 支付方式ID
	ChannelId            int64  `protobuf:"varint,18,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`                                   // 渠道ID
	BankId               int64  `protobuf:"varint,19,opt,name=bank_id,json=bankId,proto3" json:"bank_id,omitempty"`                                            // 银行ID
}
...
func (x *OrderInfo) GetActualReceivedAmount() int64 {
	if x != nil {
		return x.ActualReceivedAmount
	}
	return 0
...
func (x *OrderInfo) GetPaymentConfigId() int64 {
	if x != nil {
		return x.PaymentConfigId
	}
	return 0
...
type TransactionRecord struct {
	...
	Category        int32  `protobuf:"varint,7,opt,name=category,proto3" json:"category,omitempty"`                                       // 账变大类交易类型
	...
	TransactionTime int64  `protobuf:"varint,13,opt,name=transaction_time,json=transactionTime,proto3" json:"transaction_time,omitempty"` // 交易时间-毫秒
	RelatedId       string `protobuf:"bytes,14,opt,name=related_id,json=relatedId,proto3" json:"related_id,omitempty"`                    // 关联ID，如游戏ID，商品ID，活动ID
}
...
var file_mqtt_v1_mqtt_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x22, 0xf5, 0x01, 0x0a, 0x0c, 0x4d,
	...
	0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x28,
	0x0a, 0x10, 0x6d, 0x69, 0x6e, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x5f, 0x61, 0x6d, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x6d, 0x69, 0x6e, 0x4c, 0x69, 0x6d,
	0x69, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x61, 0x78, 0x5f,
	0x6c, 0x69, 0x6d, 0x69, 0x74, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x41, 0x6d, 0x6f, 0x75,
	0x6e, 0x74, 0x22, 0x73, 0x0a, 0x1a, 0x4d, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e, 0x74, 0x45, 0x78,
	...
	,
	...
	,
	...
	0x66, 0x69, 0x67, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x1c, 0x52, 0x65, 0x63, 0x68, 0x61, 0x72, 0x67,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x66, 0x6f, 0x22, 0xd3, 0x01, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x57, 0x69, 0x74, 0x68, 0x64,
	...
	0x0a, 0x0b, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0a, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x49, 0x64, 0x12,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64,
	0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x22, 0x7c, 0x0a, 0x18, 0x55, 0x73, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0x38, 0x0a, 0x1d, 0x55, 0x73, 0x65,
	...
	0x72, 0x61, 0x77, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73,
	...
	0x72, 0x6f, 0x77, 0x73, 0x22, 0xf4, 0x02, 0x0a, 0x0f, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61,
	0x77, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x0e, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62, 0x61, 0x6e, 0x6b, 0x53, 0x68, 0x6f, 0x77, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x69, 0x63, 0x6f, 0x6e,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x62, 0x61, 0x6e, 0x6b, 0x49, 0x63, 0x6f, 0x6e,
	0x12, 0x10, 0x0a, 0x03, 0x66, 0x65, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x66,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65,
	0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x67,
	0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xa7, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x50, 0x65, 0x6e,
	0x64, 0x69, 0x6e, 0x67, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x70, 0x6c,
	...
	0x74, 0x61, 0x6c, 0x50, 0x61, 0x67, 0x65, 0x12, 0x26, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x22,
	0xbd, 0x05, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x21, 0x0a,
	...
	,
	...
	0x28, 0x03, 0x52, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x1b, 0x0a, 0x09, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x63, 0x61, 0x72, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x0e,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x41, 0x0a, 0x06,
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6d,
	0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x50, 0x61, 0x72, 0x61,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb9, 0x01, 0x0a, 0x17, 0x55, 0x73,
	0x65, 0x72, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73, 0x67,
	...
	0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xdf, 0x02, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x61,
	0x6e, 0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73, 0x67, 0x52,
	...
	0x70, 0x6c, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x68, 0x61,
	0x72, 0x76, 0x65, 0x73, 0x74, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e,
	0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x61, 0x72, 0x76, 0x65, 0x73, 0x74, 0x53,
	...
	,
	...
	,
	...
	0x22, 0x68, 0x0a, 0x1c, 0x55, 0x73, 0x65, 0x72, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71,
	0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x1b, 0x0a,
	0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xb6, 0x01, 0x0a, 0x1e, 0x55,
	...
	0x6f, 0x77, 0x73, 0x22, 0xc2, 0x03, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	...
	0x05, 0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x73,
	0x75, 0x62, 0x5f, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0b, 0x73, 0x75, 0x62, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x29,
	0x0a, 0x10, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f,
	0x75, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f,
	...
	,
	...
	0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31,
	...
	,
	...
	,
	...
	0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f,
	0x72, 0x74, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
	0x73, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f, 0x72,
	0x74, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73,
	0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xb1, 0x01, 0x0a, 0x1c, 0x47, 0x65, 0x74,
	...
	,
	...
	0x6d, 0x65, 0x22, 0xcd, 0x01, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x49,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x28, 0x0a,
	0x10, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x7a, 0x65, 0x22, 0xa9, 0x02, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x49,
	0x6e, 0x63, 0x6f, 0x6d, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x4d, 0x73, 0x67, 0x52,
	...
	,
	...
	0x76, 0x65, 0x6c, 0x32, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x2a, 0xf2,
	0x0d, 0x0a, 0x09, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x16,
	...
	0x41, 0x57, 0x5f, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x5f,
	...
	,
	...
	0x47, 0x10, 0xa5, 0x06, 0x12, 0x21, 0x0a, 0x1c, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x53, 0x55, 0x42,
	0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x45, 0x52, 0x5f, 0x4e, 0x4f, 0x54, 0x49, 0x46, 0x59,
	0x5f, 0x4d, 0x53, 0x47, 0x10, 0xa6, 0x06, 0x12, 0x22, 0x0a, 0x1d, 0x55, 0x53, 0x45, 0x52, 0x5f,
	0x46, 0x4f, 0x52, 0x45, 0x49, 0x47, 0x4e, 0x5f, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x4e, 0x4f,
	0x54, 0x49, 0x46, 0x59, 0x5f, 0x4d, 0x53, 0x47, 0x10, 0xa7, 0x06, 0x12, 0x18, 0x0a, 0x13, 0x55,
	...
	0x54, 0x55, 0x52, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x47, 0x45, 0x10, 0x06, 0x2a, 0x7d, 0x0a, 0x11,
	...
	0x56, 0x45, 0x53, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x12, 0x10, 0x0a, 0x0c, 0x52, 0x45, 0x41,
	0x44, 0x5f, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x10, 0x05, 0x2a, 0x71, 0x0a, 0x0a, 0x57,
