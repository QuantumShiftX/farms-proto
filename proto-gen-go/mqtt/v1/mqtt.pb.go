...
const (
	...
	MessageID_USER_TRANSACTION_RECORD_MSG   MessageID = 13
	MessageID_USER_OPERATION_RECORD_MSG     MessageID = 14
	// 钱包相关消息 (100-199)
	...
	MessageID_USER_RECHARGE_INFO_MSG         MessageID = 602
	MessageID_USER_WITHDRAW_INFO_MSG         MessageID = 603
	MessageID_USER_WITHDRAW_CHANNEL_INFO_MSG MessageID = 604
	...
	MessageID_USER_LAND_CROP_CAN_OPS_INFO_MSG MessageID = 803 // 用户土地可收获状态
	// 心跳连接
...
var (
	MessageID_name = map[int32]string{
		...
		13:     "USER_TRANSACTION_RECORD_MSG",
		14:     "USER_OPERATION_RECORD_MSG",
		100:    "USER_WALLET",
		101:    "USER_BALANCE",
		...
		604:    "USER_WITHDRAW_CHANNEL_INFO_MSG",
		...
		803:    "USER_LAND_CROP_CAN_OPS_INFO_MSG",
	...
	MessageID_value = map[string]int32{
		...
		"USER_TRANSACTION_RECORD_MSG":     13,
		"USER_OPERATION_RECORD_MSG":       14,
		"USER_WALLET":                     100,
		"USER_BALANCE":                    101,
		...
		"USER_LAND_CROP_CAN_OPS_INFO_MSG": 803,
...
type RechargeChannel struct {
	...
	CurrencyCode        string `protobuf:"bytes,7,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`                        // 币种
	RechargeChannelCode string `protobuf:"bytes,8,opt,name=recharge_channel_code,json=rechargeChannelCode,proto3" json:"recharge_channel_code,omitempty"` // 充值通道编码
}
...
type UserRechargeInfoMsgReq struct {
	...
	UserId      int64  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`               // 用户ID
	Amount      int64  `protobuf:"varint,2,opt,name=amount,proto3" json:"amount,omitempty"`                             // 充值金额(分) 100 = 1元（大于0的整数）
	ChannelCode string `protobuf:"bytes,4,opt,name=channel_code,json=channelCode,proto3" json:"channel_code,omitempty"` // 通道
...
func (x *UserRechargeInfoMsgReq) GetChannelCode() string {
	if x != nil {
...
func (x *UserRechargeInfoMsgReq) GetExtra() string {
	if x != nil {
		return x.Extra
	}
	return ""
...
type UserWithdrawInfoMsgReq struct {
	...
	WithdrawAccountId int64  `protobuf:"varint,5,opt,name=withdraw_account_id,json=withdrawAccountId,proto3" json:"withdraw_account_id,omitempty"` //提现账号
...
func (x *UserWithdrawInfoMsgReq) GetExtra() string {
	if x != nil {
		return x.Extra
	}
	return ""
...
type WithdrawChannel struct {
	...
	WithdrawAccountId int64  `protobuf:"varint,1,opt,name=withdraw_account_id,json=withdrawAccountId,proto3" json:"withdraw_account_id,omitempty"` //提现账号
	UserId            int64  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                                    //用户ID
	CurrencyCode      string `protobuf:"bytes,3,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`                   // 币种
	Account           string `protobuf:"bytes,4,opt,name=account,proto3" json:"account,omitempty"`                                                 //  提现账号/地址
	AccountType       int64  `protobuf:"varint,5,opt,name=account_type,json=accountType,proto3" json:"account_type,omitempty"`                     // 账号类型 1:手机号 2:银行卡 3:PIX 4:电子钱包
	VerifyStatus      int64  `protobuf:"varint,6,opt,name=verify_status,json=verifyStatus,proto3" json:"verify_status,omitempty"`                  //  验证状态 1:已验证 2:验证失败 3:未验证
	IsDefault         int64  `protobuf:"varint,7,opt,name=is_default,json=isDefault,proto3" json:"is_default,omitempty"`                           //  是否默认账户 1:是 2:否
}
...
func (x *WithdrawChannel) GetWithdrawAccountId() int64 {
	if x != nil {
		return x.WithdrawAccountId
	}
	return 0
...
func (x *WithdrawChannel) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *WithdrawChannel) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *WithdrawChannel) GetAccountType() int64 {
	if x != nil {
...
func (x *WithdrawChannel) GetVerifyStatus() int64 {
	if x != nil {
...
func (x *WithdrawChannel) GetIsDefault() int64 {
	if x != nil {
		return x.IsDefault
	}
	return 0
...
type UserTransactionRecordMsgReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserTransactionRecordMsgReq) Reset() {
	*x = UserTransactionRecordMsgReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserTransactionRecordMsgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserTransactionRecordMsgReq) ProtoMessage() {}

func (x *UserTransactionRecordMsgReq) ProtoReflect() protoreflect.Message {
	mi := &file_mqtt_v1_mqtt_proto_msgTypes[81]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserTransactionRecordMsgReq.ProtoReflect.Descriptor instead.
func (*UserTransactionRecordMsgReq) Descriptor() ([]byte, []int) {
	return file_mqtt_v1_mqtt_proto_rawDescGZIP(), []int{81}
}

func (x *UserTransactionRecordMsgReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserTransactionRecordMsgReq) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *UserTransactionRecordMsgReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *UserTransactionRecordMsgReq) GetCategory() int64 {
	if x != nil {
		return x.Category
	}
	return 0
...
type UserTransactionRecordMsgReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserTransactionRecordMsgReply) Reset() {
	*x = UserTransactionRecordMsgReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserTransactionRecordMsgReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserTransactionRecordMsgReply) ProtoMessage() {}

func (x *UserTransactionRecordMsgReply) ProtoReflect() protoreflect.Message {
	mi := &file_mqtt_v1_mqtt_proto_msgTypes[82]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserTransactionRecordMsgReply.ProtoReflect.Descriptor instead.
func (*UserTransactionRecordMsgReply) Descriptor() ([]byte, []int) {
	return file_mqtt_v1_mqtt_proto_rawDescGZIP(), []int{82}
}

func (x *UserTransactionRecordMsgReply) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *UserTransactionRecordMsgReply) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *UserTransactionRecordMsgReply) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *UserTransactionRecordMsgReply) GetTotalPage() int64 {
	if x != nil {
		return x.TotalPage
	}
	return 0
...
func (x *UserTransactionRecordMsgReply) GetRows() []*TransactionRecord {
	if x != nil {
		return x.Rows
	}
	return nil
...
type TransactionRecord struct {
	...
	Username        string `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"`                                        // 用户账号
	OrderNo         string `protobuf:"bytes,4,opt,name=order_no,json=orderNo,proto3" json:"order_no,omitempty"`                           // 流水编号
	CurrencyCode    string `protobuf:"bytes,5,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`            // 币种编码
	WalletType      int32  `protobuf:"varint,6,opt,name=wallet_type,json=walletType,proto3" json:"wallet_type,omitempty"`                 // 账变钱包 1:用户钱包 2:代理钱包 3:奖励钱包 4:USTD钱包
	Category        int32  `protobuf:"varint,7,opt,name=category,proto3" json:"category,omitempty"`                                       // 账变大类交易类型 (1 收款、2提款、3存款、4购买、5换汇、6返佣等)
	SubCategory     int32  `protobuf:"varint,8,opt,name=sub_category,json=subCategory,proto3" json:"sub_category,omitempty"`              // 账变小类
	BalancePrevious int64  `protobuf:"varint,9,opt,name=balance_previous,json=balancePrevious,proto3" json:"balance_previous,omitempty"`  // 变动前余额, 单位:微
	Amount          int64  `protobuf:"varint,10,opt,name=amount,proto3" json:"amount,omitempty"`                                          // 变动金额, 单位:微
	BalanceAfter    int64  `protobuf:"varint,11,opt,name=balance_after,json=balanceAfter,proto3" json:"balance_after,omitempty"`          // 变动后余额, 单位:微
	TransactionType int32  `protobuf:"varint,12,opt,name=transaction_type,json=transactionType,proto3" json:"transaction_type,omitempty"` // 交易类型
	Remark          string `protobuf:"bytes,13,opt,name=remark,proto3" json:"remark,omitempty"`                                           // 备注信息
	TransactionTime int64  `protobuf:"varint,14,opt,name=transaction_time,json=transactionTime,proto3" json:"transaction_time,omitempty"` // 交易时间
	RelatedId       int64  `protobuf:"varint,15,opt,name=related_id,json=relatedId,proto3" json:"related_id,omitempty"`                   // 关联ID，如游戏ID，商品ID，活动ID
}
...
func (x *TransactionRecord) GetWalletType() int32 {
	if x != nil {
		return x.WalletType
	}
	return 0
...
func (x *TransactionRecord) GetCategory() int32 {
	if x != nil {
		return x.Category
	}
	return 0
...
func (x *TransactionRecord) GetSubCategory() int32 {
	if x != nil {
...
func (x *TransactionRecord) GetBalancePrevious() int64 {
	if x != nil {
		return x.BalancePrevious
	}
	return 0
}
...
func (x *TransactionRecord) GetBalanceAfter() int64 {
	if x != nil {
...
func (x *TransactionRecord) GetTransactionType() int32 {
	if x != nil {
...
func (x *TransactionRecord) GetRelatedId() int64 {
	if x != nil {
		return x.RelatedId
	}
	return 0
...
type UserOperationRecordMsgReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserOperationRecordMsgReq) Reset() {
	*x = UserOperationRecordMsgReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserOperationRecordMsgReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserOperationRecordMsgReq) ProtoMessage() {}

func (x *UserOperationRecordMsgReq) ProtoReflect() protoreflect.Message {
	mi := &file_mqtt_v1_mqtt_proto_msgTypes[84]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserOperationRecordMsgReq.ProtoReflect.Descriptor instead.
func (*UserOperationRecordMsgReq) Descriptor() ([]byte, []int) {
	return file_mqtt_v1_mqtt_proto_rawDescGZIP(), []int{84}
}

func (x *UserOperationRecordMsgReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserOperationRecordMsgReq) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *UserOperationRecordMsgReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *UserOperationRecordMsgReq) GetCategory() int64 {
	if x != nil {
		return x.Category
	}
	return 0
...
type UserOperationRecordMsgReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Total     int64              `protobuf:"varint,3,opt,name=total,proto3" json:"total,omitempty"`
	TotalPage int64              `protobuf:"varint,4,opt,name=total_page,json=totalPage,proto3" json:"total_page,omitempty"`
	Rows      []*OperationRecord `protobuf:"bytes,5,rep,name=rows,proto3" json:"rows,omitempty"`
}

func (x *UserOperationRecordMsgReply) Reset() {
	*x = UserOperationRecordMsgReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserOperationRecordMsgReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserOperationRecordMsgReply) ProtoMessage() {}

func (x *UserOperationRecordMsgReply) ProtoReflect() protoreflect.Message {
	mi := &file_mqtt_v1_mqtt_proto_msgTypes[85]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserOperationRecordMsgReply.ProtoReflect.Descriptor instead.
func (*UserOperationRecordMsgReply) Descriptor() ([]byte, []int) {
	return file_mqtt_v1_mqtt_proto_rawDescGZIP(), []int{85}
}

func (x *UserOperationRecordMsgReply) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *UserOperationRecordMsgReply) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *UserOperationRecordMsgReply) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *UserOperationRecordMsgReply) GetTotalPage() int64 {
	if x != nil {
		return x.TotalPage
	}
	return 0
...
func (x *UserOperationRecordMsgReply) GetRows() []*OperationRecord {
	if x != nil {
		return x.Rows
	}
	return nil
...
type OperationRecord struct {
	...
	FarmId        int64  `protobuf:"varint,4,opt,name=farm_id,json=farmId,proto3" json:"farm_id,omitempty"`                      // 农场ID
	OperationType int64  `protobuf:"varint,7,opt,name=operation_type,json=operationType,proto3" json:"operation_type,omitempty"` // 操作类型：1-浇水 2-施肥 3-收获 4-种植
...
func (x *OperationRecord) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *OperationRecord) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *OperationRecord) GetFarmId() int64 {
	if x != nil {
		return x.FarmId
	}
	return 0
...
func (x *OperationRecord) GetOperationType() int64 {
	if x != nil {
...
func (x *OperationRecord) GetOperatedAt() int64 {
	if x != nil {
		return x.OperatedAt
	}
	return 0
...
var file_mqtt_v1_mqtt_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x54, 0x0a, 0x1d, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x50, 0x61, 0x73,
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12, 0x17, 0x0a, 0x07, 0x75,
	0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73,
	0x65, 0x72, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0x22, 0x47, 0x0a, 0x1f, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64,
	...
	0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x55,
	...
	0x16, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x65, 0x61,
	...
	0x61, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x6d, 0x71, 0x74,
	0x74, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52,
	...
	0x14, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0
 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x03, 0x20,
	...
	0x6f, 0x72, 0x64, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x22, 0xd4, 0x03, 0x0a, 0x11, 0x54, 0x72,
	...
	,
	...
	0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03,
	...
	0x0f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x49, 0x64,
	0x22, 0x81, 0x01, 0x0a, 0x19, 0x55, 0x73, 0x65, 0x72, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12, 0x17,
	...
	0x67, 0x6f, 0x72, 0x79, 0x22, 0xb1, 0x01, 0x0a, 0x1b, 0x55, 0x73, 0x65, 0x72, 0x4f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x4d, 0x73, 0x67, 0x52,
	...
	0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x61, 0x67, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x72, 0x6f,
	0x77, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x71, 0x74, 0x74, 0x2e,
	0x76, 0x31, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x22, 0xb7, 0x01, 0x0a, 0x0f, 0x4f, 0x70, 0x65,
	...
	,
	...
	0x02, 0x12, 0x09, 0x0a, 0x05, 0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x03, 0x2a, 0xca, 0x01, 0x0a,
	...
	,
	...
	,
...
var file_mqtt_v1_mqtt_proto_msgTypes = make([]protoimpl.MessageInfo, 88)
var file_mqtt_v1_mqtt_proto_goTypes = []interface{}{
	...
	(*VerifySecondaryPasswordMsgReq)(nil),   // 24: mqtt.v1.VerifySecondaryPasswordMsgReq
	(*VerifySecondaryPasswordMsgReply)(nil), // 25: mqtt.v1.VerifySecondaryPasswordMsgReply
	(*UserWallet)(nil),                      // 26: mqtt.v1.UserWallet
	(*UserBalance)(nil),                     // 27: mqtt.v1.UserBalance
	(*UserStorageInfoMsgReq)(nil),           // 28: mqtt.v1.UserStorageInfoMsgReq
	(*UserStorageInfoMsgReply)(nil),         // 29: mqtt.v1.UserStorageInfoMsgReply
	(*UserStorageDetail)(nil),               // 30: mqtt.v1.UserStorageDetail
	(*FarmsStoreInfoMsgReq)(nil),            // 31: mqtt.v1.FarmsStoreInfoMsgReq
	(*FarmsStoreInfoMsgReply)(nil),          // 32: mqtt.v1.FarmsStoreInfoMsgReply
	(*StoreInfo)(nil),                       // 33: mqtt.v1.StoreInfo
	(*UserPurchaseGoodsMsgReq)(nil),         // 34: mqtt.v1.UserPurchaseGoodsMsgReq
	(*UserPurchaseGoodsMsgReply)(nil),       // 35: mqtt.v1.UserPurchaseGoodsMsgReply
	(*CropsInfoListMsgReq)(nil),             // 36: mqtt.v1.CropsInfoListMsgReq
	(*CropsInfoListMsgReply)(nil),           // 37: mqtt.v1.CropsInfoListMsgReply
	(*CropsProductInfo)(nil),                // 38: mqtt.v1.CropsProductInfo
	(*UserFarmInfoMsgReq)(nil),              // 39: mqtt.v1.UserFarmInfoMsgReq
	(*UserFarmInfoMsgReply)(nil),            // 40: mqtt.v1.UserFarmInfoMsgReply
	(*UserLandInfoMsgReq)(nil),              // 41: mqtt.v1.UserLandInfoMsgReq
	(*UserLandInfoMsgReply)(nil),            // 42: mqtt.v1.UserLandInfoMsgReply
	(*UserLandDetail)(nil),                  // 43: mqtt.v1.UserLandDetail
	(*UserPlantingDetail)(nil),              // 44: mqtt.v1.UserPlantingDetail
	(*UserFarmOpsMsgReq)(nil),               // 45: mqtt.v1.UserFarmOpsMsgReq
	(*UserFarmOpsMsgReply)(nil),             // 46: mqtt.v1.UserFarmOpsMsgReply
	(*GenerateFarmsNameMsgReq)(nil),         // 47: mqtt.v1.GenerateFarmsNameMsgReq
	(*GenerateFarmsNameMsgReply)(nil),       // 48: mqtt.v1.GenerateFarmsNameMsgReply
	(*LookUserFarmsInfoMsgReq)(nil),         // 49: mqtt.v1.LookUserFarmsInfoMsgReq
	(*LookUserFarmsInfoMsgReply)(nil),       // 50: mqtt.v1.LookUserFarmsInfoMsgReply
	(*UserFortuneTreeInfo)(nil),             // 51: mqtt.v1.UserFortuneTreeInfo
	(*AllUserRankingInfoMsgReq)(nil),        // 52: mqtt.v1.AllUserRankingInfoMsgReq
	(*AllUserRankingInfoMsgReply)(nil),      // 53: mqtt.v1.AllUserRankingInfoMsgReply
	(*UserFriendRankingInfoMsgReq)(nil),     // 54: mqtt.v1.UserFriendRankingInfoMsgReq
	(*UserFriendRankingInfoMsgReply)(nil),   // 55: mqtt.v1.UserFriendRankingInfoMsgReply
	(*FriendRankingInfo)(nil),               // 56: mqtt.v1.FriendRankingInfo
	(*MyRankingInfo)(nil),                   // 57: mqtt.v1.MyRankingInfo
	(*UserFortuneTreeInfoMsgReq)(nil),       // 58: mqtt.v1.UserFortuneTreeInfoMsgReq
	(*UserFortuneTreeInfoMsgReply)(nil),     // 59: mqtt.v1.UserFortuneTreeInfoMsgReply
	(*UserOpsFortuneTreeMsgReq)(nil),        // 60: mqtt.v1.UserOpsFortuneTreeMsgReq
	(*UserOpsFortuneTreeMsgReply)(nil),      // 61: mqtt.v1.UserOpsFortuneTreeMsgReply
	(*VipLevelInfoMsgReq)(nil),              // 62: mqtt.v1.VipLevelInfoMsgReq
	(*VipLevelInfoMsgReply)(nil),            // 63: mqtt.v1.VipLevelInfoMsgReply
	(*VIPLevelInfo)(nil),                    // 64: mqtt.v1.VIPLevelInfo
	(*GetMerchantListMsgReq)(nil),           // 65: mqtt.v1.GetMerchantListMsgReq
	(*GetMerchantListMsgReply)(nil),         // 66: mqtt.v1.GetMerchantListMsgReply
	(*MerchantInfo)(nil),                    // 67: mqtt.v1.MerchantInfo
	(*MerchantExchangeRateMsgReq)(nil),      // 68: mqtt.v1.MerchantExchangeRateMsgReq
	(*MerchantExchangeRateMsgReply)(nil),    // 69: mqtt.v1.MerchantExchangeRateMsgReply
	(*SubmitForRedemptionMsgReq)(nil),       // 70: mqtt.v1.SubmitForRedemptionMsgReq
	(*SubmitForRedemptionMsgReply)(nil),     // 71: mqtt.v1.SubmitForRedemptionMsgReply
	(*RechargeChannelsInfoMsgReq)(nil),      // 72: mqtt.v1.RechargeChannelsInfoMsgReq
	(*RechargeChannelsInfoMsgReply)(nil),    // 73: mqtt.v1.RechargeChannelsInfoMsgReply
	(*RechargeChannel)(nil),                 // 74: mqtt.v1.RechargeChannel
	(*UserRechargeInfoMsgReq)(nil),          // 75: mqtt.v1.UserRechargeInfoMsgReq
	(*UserRechargeInfoMsgReply)(nil),        // 76: mqtt.v1.UserRechargeInfoMsgReply
	(*UserWithdrawInfoMsgReq)(nil),          // 77: mqtt.v1.UserWithdrawInfoMsgReq
	(*UserWithdrawInfoMsgReply)(nil),        // 78: mqtt.v1.UserWithdrawInfoMsgReply
	(*UserWithdrawChannelInfoMsgReq)(nil),   // 79: mqtt.v1.UserWithdrawChannelInfoMsgReq
	(*UserWithdrawChannelInfoMsgReply)(nil), // 80: mqtt.v1.UserWithdrawChannelInfoMsgReply
	(*WithdrawChannel)(nil),                 // 81: mqtt.v1.WithdrawChannel
	(*UserNotificationInfoMsgReply)(nil),    // 82: mqtt.v1.UserNotificationInfoMsgReply
	(*UserBalanceInfoMsgReply)(nil),         // 83: mqtt.v1.UserBalanceInfoMsgReply
	(*UserLandStatusInfoMsgReply)(nil),      // 84: mqtt.v1.UserLandStatusInfoMsgReply
	(*UserLandCropCanOpsInfoMsgReply)(nil),  // 85: mqtt.v1.UserLandCropCanOpsInfoMsgReply
	(*SendMessage)(nil),                     // 86: mqtt.v1.SendMessage
	(*UserAnnouncementsInfoMsgReq)(nil),     // 87: mqtt.v1.UserAnnouncementsInfoMsgReq
	(*UserAnnouncementsInfoMsgReply)(nil),   // 88: mqtt.v1.UserAnnouncementsInfoMsgReply
	(*AnnouncementsInfo)(nil),               // 89: mqtt.v1.AnnouncementsInfo
	(*FarmAgreementInfoMsgReq)(nil),         // 90: mqtt.v1.FarmAgreementInfoMsgReq
	(*FarmAgreementInfoMsgReply)(nil),       // 91: mqtt.v1.FarmAgreementInfoMsgReply
	(*UserTransactionRecordMsgReq)(nil),     // 92: mqtt.v1.UserTransactionRecordMsgReq
	(*UserTransactionRecordMsgReply)(nil),   // 93: mqtt.v1.UserTransactionRecordMsgReply
	(*TransactionRecord)(nil),               // 94: mqtt.v1.TransactionRecord
	(*UserOperationRecordMsgReq)(nil),       // 95: mqtt.v1.UserOperationRecordMsgReq
	(*UserOperationRecordMsgReply)(nil),     // 96: mqtt.v1.UserOperationRecordMsgReply
	(*OperationRecord)(nil),                 // 97: mqtt.v1.OperationRecord
	nil,                                     // 98: mqtt.v1.UserNotificationInfoMsgReply.ParamsEntry
}
var file_mqtt_v1_mqtt_proto_depIdxs = []int32{
	0,  // 0: mqtt.v1.MessageWrapper.msg_id:type_name -> mqtt.v1.MessageID
	26, // 1: mqtt.v1.UserPersonalInfoMsgReply.wallets:type_name -> mqtt.v1.UserWallet
	27, // 2: mqtt.v1.UserPersonalInfoMsgReply.balances:type_name -> mqtt.v1.UserBalance
	...
	30, // 10: mqtt.v1.UserStorageInfoMsgReply.rows:type_name -> mqtt.v1.UserStorageDetail
	8,  // 11: mqtt.v1.UserStorageDetail.product_type:type_name -> mqtt.v1.ProductType
	33, // 12: mqtt.v1.FarmsStoreInfoMsgReply.rows:type_name -> mqtt.v1.StoreInfo
	...
	38, // 17: mqtt.v1.CropsInfoListMsgReply.rows:type_name -> mqtt.v1.CropsProductInfo
	...
	43, // 22: mqtt.v1.UserLandInfoMsgReply.rows:type_name -> mqtt.v1.UserLandDetail
	1,  // 23: mqtt.v1.UserLandDetail.status:type_name -> mqtt.v1.LandStatus
	44, // 24: mqtt.v1.UserLandDetail.planted_plant:type_name -> mqtt.v1.UserPlantingDetail
	...
	43, // 28: mqtt.v1.LookUserFarmsInfoMsgReply.land_detail:type_name -> mqtt.v1.UserLandDetail
	51, // 29: mqtt.v1.LookUserFarmsInfoMsgReply.fortune_tree:type_name -> mqtt.v1.UserFortuneTreeInfo
	56, // 30: mqtt.v1.AllUserRankingInfoMsgReply.rows:type_name -> mqtt.v1.FriendRankingInfo
	57, // 31: mqtt.v1.AllUserRankingInfoMsgReply.my_ranking:type_name -> mqtt.v1.MyRankingInfo
	56, // 32: mqtt.v1.UserFriendRankingInfoMsgReply.rows:type_name -> mqtt.v1.FriendRankingInfo
	57, // 33: mqtt.v1.UserFriendRankingInfoMsgReply.my_ranking:type_name -> mqtt.v1.MyRankingInfo
	64, // 34: mqtt.v1.VipLevelInfoMsgReply.rows:type_name -> mqtt.v1.VIPLevelInfo
	67, // 35: mqtt.v1.GetMerchantListMsgReply.rows:type_name -> mqtt.v1.MerchantInfo
	74, // 36: mqtt.v1.RechargeChannelsInfoMsgReply.rows:type_name -> mqtt.v1.RechargeChannel
	81, // 37: mqtt.v1.UserWithdrawChannelInfoMsgReply.rows:type_name -> mqtt.v1.WithdrawChannel
	9,  // 38: mqtt.v1.UserNotificationInfoMsgReply.type:type_name -> mqtt.v1.NotificationType
	10, // 39: mqtt.v1.UserNotificationInfoMsgReply.sub_type:type_name -> mqtt.v1.NotificationSubType
	98, // 40: mqtt.v1.UserNotificationInfoMsgReply.params:type_name -> mqtt.v1.UserNotificationInfoMsgReply.ParamsEntry
	5,  // 41: mqtt.v1.UserBalanceInfoMsgReply.wallet_type:type_name -> mqtt.v1.WalletType
	2,  // 42: mqtt.v1.UserLandStatusInfoMsgReply.is_harvested:type_name -> mqtt.v1.HarvestStatus
	3,  // 43: mqtt.v1.UserLandStatusInfoMsgReply.status:type_name -> mqtt.v1.GrowthStatus
	89, // 44: mqtt.v1.UserAnnouncementsInfoMsgReply.rows:type_name -> mqtt.v1.AnnouncementsInfo
	94, // 45: mqtt.v1.UserTransactionRecordMsgReply.rows:type_name -> mqtt.v1.TransactionRecord
	97, // 46: mqtt.v1.UserOperationRecordMsgReply.rows:type_name -> mqtt.v1.OperationRecord
...
func file_mqtt_v1_mqtt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mqtt_v1_mqtt_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserTransactionRecordMsgReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mqtt_v1_mqtt_proto_msgTypes[82].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserTransactionRecordMsgReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mqtt_v1_mqtt_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserOperationRecordMsgReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mqtt_v1_mqtt_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserOperationRecordMsgReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mqtt_v1_mqtt_proto_msgTypes[32].OneofWrappers = []interface{}{}
	type x struct{}
