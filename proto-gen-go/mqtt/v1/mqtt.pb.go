...
var file_mqtt_v1_mqtt_proto_rawDesc = []byte{
	...
	0x2a, 0xf9, 0x0c, 0x0a, 0x09, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x44, 0x12, 0x1a,
...
var file_mqtt_v1_mqtt_proto_goTypes = []interface{}{
	...
	(*UserForeignLoginNotifyMsgReply)(nil),  // 96: mqtt.v1.UserForeignLoginNotifyMsgReply
...
var file_mqtt_v1_mqtt_proto_depIdxs = []int32{
	...
	100, // 52: mqtt.v1.UserAnnouncementsInfoMsgReply.rows:type_name -> mqtt.v1.AnnouncementsInfo
	105, // 53: mqtt.v1.UserTransactionRecordsMsgReply.rows:type_name -> mqtt.v1.TransactionRecord
	108, // 54: mqtt.v1.FarmTransactionRecordsMsgReply.rows:type_name -> mqtt.v1.FarmTransactionRecord
	111, // 55: mqtt.v1.CurrencyInfoMsgReqReply.rows:type_name -> mqtt.v1.CurrencyInfo
	118, // 56: mqtt.v1.GetAgentDownlineListMsgReply.rows:type_name -> mqtt.v1.DownlineMember
	121, // 57: mqtt.v1.GetAgentIncomeDetailsMsgReply.rows:type_name -> mqtt.v1.IncomeDetail
	124, // 58: mqtt.v1.AgentRuleInfoMsgReply.deposit_rules:type_name -> mqtt.v1.DepositRewards
	125, // 59: mqtt.v1.AgentRuleInfoMsgReply.harvest_rules:type_name -> mqtt.v1.CollectionRewards
